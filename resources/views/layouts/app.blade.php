...
<html lang="pt-br">
    ...
    <body>
            ...
            <div class="col-sm-7" style="margin-top: 10px;">
                <form class="form-inline form-search">
                    ...
                    <button class="submit-search" type="submit">
                        <ion-icon name="search-outline" style="font-size: 1.8rem;"></ion-icon>
                    </button>
                </form>
            </div>
            <div class="col-sm-2">
                Olá, <span class="font-weight-bold" style="font-size: 1.2rem;">Carlos.</span><ion-icon size="large" name="cart-outline" style="vertical-align:middle;"></ion-icon>
            </div>
        </nav>
        <nav class="navbar navbar-light navbar-bg-light">
            <div class="col-sm-3">
        ...
        <!-- FOOTER -->
        <footer class="page-footer pt-4 footer-bg-dark">
            <div class="container text-md-left footer-dark">
                <div class="row">
                    <div class="footer-text-dark" style="margin-right:-40px;">
                        <ul class="list-unstyled">
                            <li><ion-icon style="font-size:60px;" name="car"></ion-icon></li>
                        </ul>
                    </div>
                    <div class="col-md-2 mx-auto footer-text-dark">
                        <ul class="list-unstyled">
                            <li><h5>Frete Grátis</h5></li>
                            <li>Acima de R$ 200,00</li>
                        </ul>
                    </div>
                    <div class="footer-text-dark" style="margin-right:-40px;">
                        <ul class="list-unstyled">
                            <li><ion-icon style="font-size:60px;" name="card"></ion-icon></li>
                        </ul>
                    </div>
                    <div class="col-md-3 mx-auto footer-text-dark">
                        <ul class="list-unstyled">
                            <li><h5>Em até 10x sem juros</h5></li>
                            <li>No cartão de crédito</li>
                        </ul>
                    </div>
                    <div class="footer-text-dark" style="margin-right:-40px;">
                        <ul class="list-unstyled">
